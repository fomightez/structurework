...
def generate_missing_report(PDBid, return_report_string = True):
    ...
    if STILL_IN_EARLY_DEVELOPMENT:
        ...
        elif PDBid == "4tst": # add this in to allow testing prioritizing local file handling; this is for a non-existent PDB code, see https://proteopedia.org/wiki/index.php/Believe_It_or_Not#Notes
