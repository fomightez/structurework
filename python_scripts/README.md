...
<br>
For example, calling the program to run with `python merge_multi_PDBs_into_single_file.py test_folder`, if `test_folder` contains `1crn_3.pdb`, `1tup_5.pdb`, and `1ehz_7.pdb`, the final file will have three models numbered 1 through 3 and they will correspond to 1crn, 1tup, and 1ehz.
